...
// Debug: ตรวจสอบว่า $conn ถูกสร้างหรือไม่
if (!isset($conn) || $conn === null) {
    die("Error: \$conn is not defined. Please check config.php location and content.");
}
...
<html>
<head>
    <title>ระบบล็อกอิน | ULG Portal</title>
    <meta charset="utf-8">
