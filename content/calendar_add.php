    ...
    if ($stmt = mysqli_prepare($conn, $sql)) {
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            try {
                ...
                $message .= "\n🔗 ดูรายละเอียด: https://www.weedjai.com/content/calendar_detail.php?id=$new_id";
            ...
            header("refresh:2;url=calendar_dashboard.php");
        } else {
...
<div class="container">
    ...
    <form method="POST" action="">
        ...
        <div class="button-group">
            ...
            <a href="calendar_dashboard.php" class="btn btn-secondary">❌ ยกเลิก</a>
        </div>
    </form>
</div>
