...
// ================= 1. CONFIGURATION =================
$db_file = 'inventory_sync_soup.db';
$WAREHOUSE_LIST = [
    '10000' => 'ULG DC OFFICE', 
    '17020' => 'SOUP EMSPHERE', 
    '77010' => 'PRONTO WEB'
...
$SHOP_CONFIG = [
    ...
    'token' => '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',
    'version' => '2026-01',
    'location_id' => '107084022073', 
];
...
<body class="bg-slate-50 p-8 font-sans min-h-screen">
    <div class="max-w-6xl mx-auto">
        <div class="bg-white rounded-3xl shadow-lg p-6 mb-8 flex justify-between items-center border-t-4 border-indigo-600">
            <div><h1 class="text-2xl font-black text-slate-800 tracking-tighter italic uppercase">SOUP Sync V3.1.7</h1><p class="text-slate-500 text-[10px] font-bold uppercase tracking-widest mt-1">Selective Sync Mode | 100 Items/Page</p></div>
